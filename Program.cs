...
public partial class Program
{
    ...
    static Sound gameover, snipershot, karambitshot, bazookashot, shotgunshot, pistolshot, revolvershot, swordslash, select, unselect, survole, swoosh, explosion;
    ...
    static void Main()
    {
        ...
        gameover = Raylib.LoadSound("assets\\sounds\\gameover.mp3");
