...
partial class Program
{
    ...
    const float ARME_OFFSET_DROITE = 0.40f;  // décalage vers la main droite
    ...
    const float ARME_VISEE_COTE = 0.50f;     // décalage latéral en visée (signe à inverser si mauvais côté)
